...
(auctions + bids + EMD ledger bits), `offers_slice.sql` (listing_offers negotiation + 0020 RLS), `requirements_slice.sql` (reverse marketplace: requirements + requirement_responses), `logistics_slice.sql` (shipments + shipment_events fulfilment), and `02_seed_min.sql`.
