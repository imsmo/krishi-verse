...
@Module({
  controllers: [NotificationsController, PreferencesController, TemplatesController, DeliveryWebhookController, ConversationsController, MaskedCallsController, MaskedCallWebhookController],
  providers: [
    NotificationService, PreferenceService, TemplateAdminService, ConversationService, MessageService, MaskedCallService,
    ...
    ConversationRepository, MessageRepository, MaskedCallRepository,
