...
module.exports = {
  projects: [
    ...
    },
    {
      ...
      testMatch: ['<rootDir>/modules/listings/__tests__/**/*.integration.spec.ts', '<rootDir>/modules/identity/__tests__/**/*.integration.spec.ts', '<rootDir>/modules/catalogue/__tests__/**/*.integration.spec.ts', '<rootDir>/modules/orders/__tests__/**/*.integration.spec.ts', '<rootDir>/modules/payments/__tests__/**/*.integration.spec.ts', '<rootDir>/modules/auctions/__tests__/**/*.integration.spec.ts', '<rootDir>/modules/offers/__tests__/**/*.integration.spec.ts', '<rootDir>/modules/requirements/__tests__/**/*.integration.spec.ts', '<rootDir>/modules/logistics/__tests__/**/*.integration.spec.ts', '<rootDir>/modules/reviews/__tests__/**/*.integration.spec.ts', '<rootDir>/modules/disputes/__tests__/**/*.integration.spec.ts', '<rootDir>/modules/promotions/__tests__/**/*.integration.spec.ts', '<rootDir>/modules/memberships/__tests__/**/*.integration.spec.ts', '<rootDir>/core/**/__tests__/**/*.integration.spec.ts'],
    },
  ],
};
